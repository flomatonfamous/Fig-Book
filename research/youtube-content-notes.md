...
**Confirmed facts from video:**
- Parthenocarpic varieties: explained on camera using eggplant as a parallel example ("hybrid variety that do not produce seeds on the inside") — same plain-language approach works for the book
- Caprifig purpose confirmed: "I'm going to use for pollinating other figs so that when you pollinate a fig it takes on a completely different flavor" — this is the "more on that later" teaser already in Ch. 2
- Breba crop explanation from video: "All this old wood that you see here, whenever this old wood starts sending off figs in the early spring, that's known as the breba crop. Your main crop comes on all your new growth."
- His actual breba preference: "To me, the main crop just tastes so much better than a breba crop... I don't really waste my time finding varieties known to produce the breba crop because they're just really not worth the effort."
- Exception to his anti-breba opinion: **Desert King** — "only ever makes a breba crop, but it's probably one of the best breba crops. That's why I've added it in my collection."

**BREBA STORY SLOT — now filled from video:**
> "In my orchard, LSU DC-6 is the first one to give me figs every year — that's its breba crop coming off the old wood in May or June. I don't chase breba varieties as a rule. To me, the main crop just tastes better. But there are exceptions. Desert King, for instance, only ever makes a breba crop, and it's one of the best-tasting ones I've got. Every rule has a fig that'll make you rethink it." [SYNTHESIZE — do not quote directly]

---

## CHAPTER 3 — A World of Varieties + Flavor Profiles

**Randall's confirmed variety opinions (for use in Ch. 3 — his personal perspective):**
...
| Meline de Saison | "Fastly becoming one of my favorites." Mild berry flavor, very productive, impressive growth | Rising favorite |
| White Madeira #1 | "Adriatic green fig, red strawberry, but the flavor of this one is incredible." | Standout green fig |
| Violette de Bordeaux | "No collection is complete without it." Available at Lowe's. | Strongly recommended |
| Olympian | Cold hardy, available at big box stores (Lowe's). Good spreading habit. | Starter/cold climate recommendation |
| White Marseilles | "One of the best yellow figs there is." Available at big box stores. | Easy to find, high quality |
| Smith | "One of my favorites to eat" — but not cold hardy, dies to the ground, twice replaced with Texas BA1 | Flavor 10, cold hardiness 2 |
| Texas BA1 | "The cold-hardy Smith." Very similar flavor, survives cold better. | Cold climate substitute for Smith |
| Soles/Souls | "Everybody knows in the fig community this is one of the top tier figs." First fruits in year 3. | Community consensus + personal confirmation |
| Colonel Litman's Black Cross | "Known as a top tier quality fig." Dark berry flavor. | Top tier |
| Italian 258 | "Top 10 quality fig." | Confirmed top 10 |
| Black Madeira | "Cornerstone top 10 if not the number one fruit." Ultra slow growing tree. | Considered the best by many |
| Patsy's Pride | "That's a good quality fig. I enjoy that one." (got from friend Mike Gabriel) | Personal confirmation |
| Glacia Negra | Three years in ground, no fruit yet. Highly anticipated. "People rave about how good this one is." | Still waiting — anticipation only |
| Desert King | Only makes a breba crop, but "probably one of the best breba crops" | San Pedro type — breba only |
| Ronde Bordeaux | Tends to split in humidity and rain. Good flavor when it ripens without splitting. | Humid climate warning |
| Red Book | "I was hoping it would taste bad just to be a little unique. I'm happily disappointed it actually tastes pretty good." (from Terry in Louisiana) | Humor + honest review |
| California Brown Turkey | "Not to be confused with Southern Brown Turkey. Completely different fig. Makes a bigger fig and is better tasting." | Important distinction — already in Ch. 2 |

**Naming/synonyms for Appendix:**
- Strawberry Verte and LSU Strawberry: "Same leaf, same fruit, same ripening period. If it's not the same, it's close." — good Appendix entry
- Tina (tissue culture Black Madeira): "We thought it was a Black Madeira, it turned out to not be true, it's more of a yellow fig." — good mislabeling example
- Black Madeira vs. Black Madeira KK vs. Black Madeira tissue culture — three distinct versions

---

## CHAPTER 4 — Choosing the Right Fig for You

**From video — practical selection advice:**
- For beginners just starting out: Chicago Hardy, Brown Turkey — "introductory level figs without having to go all in"
- For a good off-the-shelf fig: Violette de Bordeaux, Olympian, White Marseilles — all available at big box stores
- For cold climates: Olympian ("cold hardy type"), Texas BA1 ("cold hardy Smith")
- For container growing: figs sold in tree pots (4x9) are standard for shipping and container culture
- For someone wanting fruit fast: buy an established tree, not cuttings. "An established tree comes with a root system that's ready to go, and you might get fruit the same year."

---

## CHAPTER 5 — Planting and Growing Figs Right

**Orchard spacing confirmed:**
- 12 feet apart in offset pattern (trees offset 6 feet between rows)
- 10 feet from fence line on each side
- 15 trees per row, 12 feet apart

**Soil confirmed:**
- South Alabama: approximately 1 foot of nice loamy topsoil, easy to dig
- "If we were dealing with heavier soil I'd dig bigger holes and backfill with loose soil around the plant" — good container-to-ground tip

**Irrigation confirmed:**
- Drip ring irrigation on timers, trenched underground
- Allows grass to grow over drip rings to protect from mower
- Without irrigation, dry summers severely limit fruit production (Year 1 lesson from his orchard)

**Pruning goal confirmed:**
- Target: 3 to 4 main stalks from base in a bush format
- "Three stalks, kind of a bush format" — for production and future big-tree propagation
- Trims everything else as cuttings

**Bad winter on record:**
- Got down to 15°F, everything died to the ground in the orchard
- "All the growth you see is this year's growth" (Oct. 2025 video)
- That's tip dieback AND root-level kill from an extreme cold event — good real example for Ch. 9

---

## CHAPTER 8 — Propagation

**Randall's full method — confirmed from video:**

| Step | Detail |
|------|--------|
| Timing | Late fall / early winter in Zone 8b-9 (October-November); "perfect time for rooting cuttings" when temps are 68°F nights, 80-82°F days |
| Wood type | Lignified (hardened brown wood from current year) — NOT soft green growth |
| Cutting size | ~6 inches, minimum 3 nodes |
| Bottom cut | Quarter inch below a node |
| Labeling | Pencil on pot — doesn't fade in sun, doesn't smear when wet |
| Waxing | Tops only. Wax blend: gulf/canning wax + beeswax (for pliability) + toilet wax ring (to stretch supply and add stick). Heated in a deep cylindrical stainless pot in a thrift-store soup warmer (~$20). Quick dip in, quick dip out. |
| **DO NOT wax both ends** | Confirmed failure: 5 rooted out of 75 cuttings when both ends waxed. Viewer suggestion he tried and abandoned. |
| Rooting hormone | Hormodin 3 (8% IBA). Dust lightly — do NOT wet the cutting first. Too much IBA can inhibit root development. |
| Rooting medium | Promix BX (well-draining, contains mycorrhizae). Do NOT use moisture-retaining potting mix. |
| Pots | 2" nursery pots in 32-count trays (with drain holes — no standing water) |
| Environment | 50% shade cloth. Keep out intense sun but still have light. Heated/ventilated greenhouse. |
| Up-potting | Once rooted (~2 months), move to 4x9 tree pots. Ready to sell/ship at that size. |
| Success rate | 94% with this method (late summer cuttings, his best batch). Average for new growers without greenhouse: ~50%. |

**Cuttings vs. trees — Randall's recommendation:**
- New growers without a proper rooting environment: buy established trees, don't gamble on cuttings
- Cuttings: $7–$12 each, 50% success rate for beginners = expensive
- Established trees: $30–$40 (common varieties), up to $100–$150 for rare varieties
- Benefits of cuttings: cheaper per variety, can root extras to sell back and recover costs
- Shipping concern: established trees can suffer transplant shock, soil shifts in transit

**Cutting sources mentioned:**
- FigBid (like eBay for figs)
- proigusa.com (Randall has used with good results)
- Fig gathering in Chattanooga, Tennessee (IAS-type event — confirm name before printing)
- Local trades and gifting (community culture)

---

## CHAPTER 9 — Getting Through Winter

**Bad freeze on record (confirmed from video):**
- Winter 2024-25: Got down to 15°F
- Everything in the orchard died all the way back to the root
- "All the growth you see here is this year's growth" (October 2025 orchard tour)
- Some varieties came back later than others — Cadum Negra Ramada didn't push until almost summer
- Smith did not come back at all (twice). Very cold-sensitive.
- Some varieties confirmed cold-sensitive: Smith, Cadum Ramada (struggling), various Mediterranean types
- Texas BA1 as a cold-hardy substitute for Smith confirmed

**Protecting in-ground trees:**
- Keeping old wood matters for breba crop — if the tree dies to ground, no breba that year
- Trees in ground 3 years have established root systems that usually survive if given protection

---

## CHAPTER 11 — Building a Fig Collection

**Community specifics from video (use in Ch. 11):**
- **FigBid**: "Like eBay but just for figs, and some other fruit trees." He sells there. Main platform for collector trading.
- **Fig gathering in Chattanooga, Tennessee**: He attends. Can buy trees, meet growers. Mentions it as where he got Angelique and Glacia Negra.
- **Variety naming confusion confirmed on camera**: tissue-cultured "Black Madeira" shipped out as Tina (yellow fig) by mistake; Strawberry Verte and LSU Strawberry may be the same variety; multiple names for same variety is a real problem
- **Community generosity**: He gives cuttings freely, trades with friends. "Croatian David the Good" — got a fig from David the Good, named it himself.
- **Community figures named**: "Terry in Louisiana" (gave him Red Book and Pan Island), "David the Good," "friend Mike Gabriel" (gave him Patsy's Pride), "friend Randy" (Glacia Negra)
- **The obsession / collector's psychology**: He planted 142 varieties in ground. He built an irrigation system. He bought an acre and a half next door just for the fig orchard. He can't bring himself to take cuttings because trees still have figs on them. That's the collector mindset — in his own life.

---

## CHAPTER 12 — From Hobby to Income

**Business details confirmed from video:**
- Licensed Alabama Nursery (confirmed in videos)
- Ships in 4x9 tree pots (standard in fig community)
- Sells: FigBid, local, website (Webador), Etsy
- Started by buying trees, then learned to propagate
- Built propagation system progressively: heat mats → barn → greenhouse with climate control
- Now works remote from home (office in barn), steps outside after workday into the nursery
- Fig festival planned: "We plan to have a fig festival where you can come out and taste figs and buy trees."
- Pricing: Chicago Hardy ~$25-30, rare varieties (White Madeira #1) ~$100+

---

## APPENDIX — Variety naming and synonyms

**Confirmed naming confusion / synonym issues (for Appendix entry):**
- Strawberry Verte = possibly LSU Strawberry (same leaf, same fruit, same timing — Randall keeping them labeled separately until confirmed)
- Tina ≠ Black Madeira (tissue culture mix-up at the nursery)
- California Brown Turkey ≠ Southern Brown Turkey (completely different fig — already in PROJECT.md)
- Cadum/Codam/Coldom = spelling variation of the same series (Randall uses all three spellings)
- Pan Island = possibly LSU Honey ("some talk going back and forth")
- Croatian David the Good = unnamed fig, Mount Etna type (no confirmed variety name)
- Desert King = San Pedro type, breba crop only
- Smith = a flavor standard that many growers compare other dark figs against
